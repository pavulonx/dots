...
Config { font    = "xft:Segoe UI:size=9:antialias=true:hinting=true:fontformat=truetype"
       ...
       , sepChar = "%"
       , alignSep = "}{"
       , template = " %UnsafeStdinReader% }{ <fc=#666666> |</fc> <fc=#b3afc2><fn=4></fn>  %uname% </fc><fc=#666666> |</fc> <fc=#ecbe7b> %cpu% </fc><fc=#666666> |</fc> <fc=#ff6c6b> %memory% </fc><fc=#666666> |</fc> <fc=#51afef> %disku% </fc><fc=#666666> |</fc> <fc=#98be65> %enp6s0% </fc><fc=#666666> |</fc>  <fc=#c678dd><fn=4></fn>  %pacupdate% </fc><fc=#666666> |</fc> <fc=#46d9ff> %date%  </fc><fc=#666666><fn=4>|</fn></fc>%trayerpad%"
       }
